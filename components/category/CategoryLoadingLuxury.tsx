...
const CategoryLoadingLuxury = () => {
  return (
    <div className="min-h-[70vh] bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 relative overflow-hidden rounded-lg">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[70vh] text-center space-y-8 p-8">
        {/* Logo/Icono de lujo */}
        <div className="relative mx-auto w-32 h-24">
          ...
          />
          <Filter className="absolute -right-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-pink-400 animate-bounce" />
          <Droplets
            className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-6 h-6 text-purple-400 animate-bounce"
            style={{ animationDelay: "0.5s" }}
          />
          <Search className="absolute -left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-rose-400 animate-pulse" />
        </div>
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-2xl font-light text-gray-700 animate-fade-in-out">
            Curando productos excepcionales
          </h2>
          <p
            className="text-gray-600 leading-relaxed animate-fade-in-out max-w-md"
            style={{ animationDelay: "0.5s" }}
          >
            Cada producto es seleccionado cuidadosamente para ofrecerte la mejor
            experiencia de cuidado natural
          </p>
        </div>

        {/* Barra de progreso elegante */}
        <div className="space-y-3">
          <div className="w-96 h-2 bg-white/30 rounded-full overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
          ...
          >
            ...
            <p className="text-sm font-medium text-gray-700">Artesanal</p>
          </div>
        </div>
      </div>
...
export default CategoryLoadingLuxury;
