...
// Variable: query
// Query: *[_type == "product" && count(categories[]->_ref[@in $categoryIds]) > 0 && slug.current != $currentProductSlug][0...4]{    _id,    name,    slug,    price,    discount,    description,    richDescription,    images[]{      asset->{        url      }    },    stock  }
...
// Query: *[_type == "product" && slug.current == $slug] | order(name asc) [0]{    ..., // Esto selecciona todas las propiedades de nivel superior del producto    categories[]->{       _id,      name,       slug,          },  }
